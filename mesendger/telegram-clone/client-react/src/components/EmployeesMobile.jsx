...
export default function EmployeesMobile({ open, onClose, onOpenMobileSidebar }) {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        data-modal-id="employees"
        style={{
          position: 'relative',
          width: '100%',
          height: '100%',
          background: 'var(--modal-employees-background, linear-gradient(135deg, #232931 0%, #181c22 100%))',
          backgroundImage: 'var(--modal-employees-background-image, none)',
