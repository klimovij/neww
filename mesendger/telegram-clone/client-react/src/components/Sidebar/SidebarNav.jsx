                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        padding:12,
                        borderRadius:10,
                        background: active===n.key ? n.color : 'var(--sidebar-button-background, #232931)',
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                        backgroundRepeat: 'no-repeat',
                        color: active===n.key ? (n.key==='tasks'? '#fff':'#222') : 'var(--sidebar-text-color, #fff)',
                        fontWeight:600,
                        fontFamily: 'var(--sidebar-font-family, Inter, system-ui, -apple-system, sans-serif)',
                        border:'none',
                        cursor:'pointer',
                        display:'flex',
                        alignItems:'center',
                        gap:10,
                        fontSize: active===n.key ? '1.08em' : 'var(--sidebar-text-size, 14px)',
