...
# Выполните на сервере через SSH: bash UPDATE_FRONTEND_NOW.sh
...
echo ""
echo "🔍 Проверьте изменения в браузере:"
echo "   Откройте модалку активности и проверьте, что для Telegram/Viber показывается windowTitle"
